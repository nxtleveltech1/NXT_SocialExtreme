...
export const env = {
  ...
  NEXT_PUBLIC_STACK_PROJECT_ID: requireEnv("NEXT_PUBLIC_STACK_PROJECT_ID"),
  NEXT_PUBLIC_STACK_PUBLISHABLE_CLIENT_KEY: requireEnv("NEXT_PUBLIC_STACK_PUBLISHABLE_CLIENT_KEY"),
  STACK_SECRET_SERVER_KEY: requireEnv("STACK_SECRET_SERVER_KEY"),
} as const;
