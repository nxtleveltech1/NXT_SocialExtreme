      ...
      <div className="h-full">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4 w-full">
            {[
              { emoji: "🎧", name: "Fones Bluetooth", price: "R$ 299,99" },
              { emoji: "🔌", name: "Carregadores", price: "R$ 89,99" },
              { emoji: "🔗", name: "Cabos USB-C", price: "R$ 49,99" },
              { emoji: "🔋", name: "Power Banks", price: "R$ 159,99" },
            ].map((item) => (
              <div key={item.name} className="bg-white/20 backdrop-blur-sm rounded-xl p-4 text-center">
                <div className="text-4xl mb-2">{item.emoji}</div>
                <div className="text-white font-medium">{item.name}</div>
                <div className="text-green-100 font-bold">{item.price}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        >
          <div className="text-center space-y-6">
            ...
            <p className="text-green-100 text-sm">{appUrl}</p>
          </div>
        </div>
      </div>
